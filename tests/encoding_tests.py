...
def test_encode_field_array():
    expectation = ('\x00\x00\x00<U\x00\x01I\x00\x00\xaf\xc8S\x00\x00\x00'
                   ...
                   '\x00\x00\x01:f@H\xf5\xc3L\x00\x00\x00\x00\xc4e5\xffL\x80'
...
def test_encode_field_table():
    expectation = ('\x00\x00\x04\x13\x07longvalI6e&U\x08floatvlaf@H\xf5\xc3'
                   '\x07boolvalt\x01\x06strvalS\x00\x00\x00\x04Test\x06intv'
                   'alU\x00\x01\x07longstrS\x00\x00\x03t0000000000000000000'
                   '0000000000000000000000000000000001111111111111111111111'
                   '1111111111111111111111111111112222222222222222222222222'
                   '2222222222222222222222222221111111111111111111111111111'
                   '1111111111111111111111112222222222222222222222222222222'
                   '2222222222222222222221111111111111111111111111111111111'
                   '1111111111111111112222222222222222222222222222222222222'
                   '2222222222222221111111111111111111111111111111111111111'
                   '1111111111112222222222222222222222222222222222222222222'
                   '2222222221111111111111111111111111111111111111111111111'
                   '1111112222222222222222222222222222222222222222222222222'
                   '2221111111111111111111111111111111111111111111111111111'
                   '2222222222222222222222222222222222222222222222222222111'
                   '1111111111111111111111111111111111111111111111111222222'
                   '2222222222222222222222222222222222222222222222111111111'
                   '1111111111111111111111111111111111111111111000000000000'
                   '0000000000000000000000000000000000000000\x0ctimestampva'
                   'lT\x00\x00\x00\x00Ec)\x92\x06decvalD\x02\x00\x00\x01:'
                   '\x08arrayvalA\x00\x00\x00\tU\x00\x01U\x00\x02U\x00\x03'
                   '\x07dictvalF\x00\x00\x00\x0c\x03fooS\x00\x00\x00\x03bar'
        )
    data = {'intval': 1,
            'strval': 'Test',
            'boolval': True,
...
def test_encode_by_type_field_table():
    expectation = ('\x00\x00\x04\x13\x07longvalI6e&U\x08floatvlaf@H\xf5\xc3'
                   ...
                   '1111111111111111111111111111111111111111111000000000000'
                   '0000000000000000000000000000000000000000\x0ctimestampva'
                   'lT\x00\x00\x00\x00Ec)\x92\x06decvalD\x02\x00\x00\x01:\x08'
                   'arrayvalA\x00\x00\x00\tU\x00\x01U\x00\x02U\x00\x03\x07d'
                   'ictvalF\x00\x00\x00\x0c\x03fooS\x00\x00\x00\x03bar')
    data = {'intval': 1,
            'strval': 'Test',
            'boolval': True,
            'timestampval': datetime(2006, 11, 21, 16, 30, 10),
