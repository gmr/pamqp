...
class DemarshalingTests(unittest.TestCase):
    ...
    def test_basic_consumeok(self):
        frame_data = (
            b'\x01\x00\x01\x00\x00\x00\x0c\x00<\x00\x15\x07ctag1.0\xce'
        )
        expectation = {'consumer_tag': 'ctag1.0'}
    ...
    def test_basic_get(self):
        frame_data = (
            b'\x01\x00\x01\x00\x00\x00\x0c\x00<\x00F\x00\x00\x04test\x00\xce'
        )
    ...
    def test_basic_properties(self):
        encoded_properties = (
            b'\xff\xfc\x10application/json\x04gzip\x00\x00'
        ...
        properties = {
            ...
            'timestamp': datetime.datetime(
                2012, 10, 2, 9, 51, 3, tzinfo=datetime.UTC
            ),
    ...
    def test_basic_publish(self):
        frame_data = (
            b'\x01\x00\x01\x00\x00\x00\r\x00<\x00(\x00\x00\x00\x04test\x00\xce'
        )
        expectation = {
            'ticket': 0,
            'mandatory': False,
    ...
    def test_channel_openok(self):
        frame_data = (
            b'\x01\x00\x01\x00\x00\x00\x08\x00\x14\x00\x0b\x00\x00\x00\x00\xce'
        )
        ...
        self.assertEqual(
            channel,
            1,
            f'Channel number did not match expectation: {channel}, {1}',
        )
    ...
    def test_content_body_frame(self):
        frame_data = (
            b'\x03\x00\x00\x00\x00\x00"Hello World #0:1316899165.75516605\xce'
        )
    ...
    def test_queue_deleteok(self):
        frame_data = (
            b'\x01\x00\x01\x00\x00\x00\x08\x002\x00)\x00\x00\x00\x00\xce'
        )
    ...
    def test_queue_purgeok(self):
        frame_data = (
            b'\x01\x00\x01\x00\x00\x00\x08\x002\x00\x1f\x00\x00\x00\x01\xce'
        )
