...
class Struct:
    ...
    integer: struct.Struct = struct.Struct('>I')
    uint: struct.Struct = struct.Struct('>i')
    long_long_int: struct.Struct = struct.Struct('>q')
    short_short_int: struct.Struct = struct.Struct('>b')
    short_short_uint: struct.Struct = struct.Struct('>B')
    timestamp: struct.Struct = struct.Struct('>Q')
    long: struct.Struct = struct.Struct('>l')
    ulong: struct.Struct = struct.Struct('>L')
