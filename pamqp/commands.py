...
class Connection:
    ...
    class Start(base.Frame):
        ...
        __annotations__: typing.Dict[str, object] = {
            ...
            int,
            'server_properties':
            typing.Optional[typing.Dict[str, common.FieldValue]],
            'mechanisms':
            str,
            'locales':
            str
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Connection.Start` class
    ...
    class StartOk(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Connection.StartOk` class
    ...
    class Secure(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Connection.Secure` class
    ...
    class SecureOk(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Connection.SecureOk` class
    ...
    class Tune(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Connection.Tune` class
    ...
    class TuneOk(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Connection.TuneOk` class
    ...
    class Open(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Connection.Open` class
    ...
    class OpenOk(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Connection.OpenOk` class
    ...
    class Close(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Connection.Close` class
    ...
    class Blocked(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Connection.Blocked` class
    ...
    class UpdateSecret(base.Frame):
        ...
        def __init__(self, new_secret: str = None, reason: str = None) -> None:
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Connection.UpdateSecret` class
...
class Channel:
    ...
    class Open(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Channel.Open` class
    ...
    class OpenOk(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Channel.OpenOk` class
    ...
    class Flow(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Channel.Flow` class
    ...
    class FlowOk(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Channel.FlowOk` class
    ...
    class Close(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Channel.Close` class
...
class Exchange:
    ...
    class Declare(base.Frame):
        ...
        def __init__(
            ...
            internal: bool = False,
            nowait: bool = False,
            arguments: typing.Optional[typing.Dict[str,
                                                   common.FieldValue]] = None
        ) -> None:
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Exchange.Declare` class
    ...
    class Delete(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Exchange.Delete` class
    ...
    class Bind(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Exchange.Bind` class
    ...
    class Unbind(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Exchange.Unbind` class
...
class Queue:
    ...
    class Declare(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Queue.Declare` class
    ...
    class DeclareOk(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Queue.DeclareOk` class
    ...
    class Bind(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Queue.Bind` class
    ...
    class Purge(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Queue.Purge` class
    ...
    class PurgeOk(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Queue.PurgeOk` class
    ...
    class Delete(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Queue.Delete` class
    ...
    class DeleteOk(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Queue.DeleteOk` class
    ...
    class Unbind(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Queue.Unbind` class
...
class Basic:
    ...
    class Qos(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Basic.Qos` class
    ...
    class Consume(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Basic.Consume` class
    ...
    class ConsumeOk(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Basic.ConsumeOk` class
    ...
    class Cancel(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Basic.Cancel` class
    ...
    class CancelOk(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Basic.CancelOk` class
    ...
    class Publish(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Basic.Publish` class
    ...
    class Return(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Basic.Return` class
    ...
    class Deliver(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Basic.Deliver` class
    ...
    class Get(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Basic.Get` class
    ...
    class GetOk(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Basic.GetOk` class
    ...
    class GetEmpty(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Basic.GetEmpty` class
    ...
    class Ack(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Basic.Ack` class
    ...
    class Reject(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Basic.Reject` class
    ...
    class RecoverAsync(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Basic.RecoverAsync` class
    ...
    class Recover(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Basic.Recover` class
    ...
    class Nack(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Basic.Nack` class
...
class Confirm:
    ...
    class Select(base.Frame):
        ...
        def check(self) -> None:
            """Checks the inner class data :py:class:`Confirm.Select` class
