...
class Connection:
    ...
    class Open(base.Frame):
        ...
        :raises ValueError: when an argument does not validate
    ...
    class OpenOk(base.Frame):
        ...
        :raises ValueError: When `known_hosts` is not empty
...
class Channel:
    ...
    class Open(base.Frame):
        ...
        :raises ValueError: when `out_of_band` is specified
    ...
    class OpenOk(base.Frame):
        ...
        :raises ValueError: when `channel_id` is specified
...
class Exchange:
    ...
    class Declare(base.Frame):
        ...
        .. note:: The ``type`` argument is referred to as ``exchange_type``
...
class Basic:
    ...
    class Qos(base.Frame):
        ...
        .. Note:: The property ``global`` is named ``globally`` as to
                  not conflict with the Python ``global`` keyword
    ...
    class GetEmpty(base.Frame):
        ...
        :raises ValueError: when ``cluster_id`` is not empty
    ...
    class Properties(base.BasicProperties):
        ...
        .. Note:: The property ``type`` is named ``message_type`` as to
